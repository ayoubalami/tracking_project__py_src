    ...
    def readStream(self):
        ...
        while True :
            ...
            if self.stop_reading_for_loading or len(self.buffer.buffer_frames)==0 :
                continue
            frame,batch=self.buffer.buffer_frames[self.last_readed_frame_index]
            ...
            # del(self.buffer.buffer_frames[self.last_readed_frame_index])
            ...
            # print(calculeTime)
            # print(delay)
            # print(self.buffer.frame_duration)
            # print("==========")
            ...
            if (self.buffer.frames_count==self.last_readed_frame_index):
